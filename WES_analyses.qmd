...
```{r}
#Figure S3A) Oncoprint according to HPV status
colda <- clinical_data_raw %>% filter(Article_I == "Yes")
colda <- colda %>% mutate(Death = case_when(
  !is.na(Death_date) ~ 1,
  is.na(Timing_Rbiopsy_OS_date) ~
...
```{r}
#Figure S1A-B) Association of TMB to other genomic parameters
...
```{r}
#Figure 2A) Most common SNVs in HPV-positive patients
...
```{r}
#Figure 2B) Most common SNVs in HPV-negative patients
...
```{r}
#Figure 2C) Most common CNV in HPV-positive patients
...
```{r}
#Figure 2D) Most common CNVs in HPV-negative patients
...
```{r}
#Figure 2D) Genomic alterations in pathways according to HPV status
...
```{r}
#Figure S3B) Oncoprint with HPV subtypes
...
```{r}
#Figure 3A) Genomic features affected by consumption
...
```{r}
#Figure 3B) Genomic features affected by primary diagnosis site
...
```{r}
#Figure S4A) Relation between genomic parameters and consumption 
molecular_scores[clinical_data_rm_wes$HPV_status_temp == "Negative" & !is.na(clinical_data_rm_wes$Consumption),]  %>%
  ggplot(aes(clinical_data_rm_wes$Consumption[clinical_data_rm_wes$HPV_status_temp == "Negative" & !is.na(clinical_data_rm_wes$Consumption)] , tmb)) + geom_boxplot(linewidth = 0.8) +
  theme_bw(base_size = 30, base_family = "Helvetica") +
  labs(x = "", y = "TMB (mutations/Mb)") + 
  theme(text = element_text(size = 18)) + 
  stat_compare_means(label= "p", label.x = 1.4) +
  scale_x_discrete(labels = c("Non_smoker_non_drinker" = "Non smokers non drinkers",
                              "Smoker_and_or_drinker" = "Smokers and/or drinkers"))

molecular_scores[samples_data_rm_wes$specimen_type == "Fresh Frozen tissue" & clinical_data_rm_wes$HPV_status_temp == "Negative",]  %>%
  ggplot(aes(clinical_data_rm_wes$Consumption[samples_data_rm_wes$specimen_type == "Fresh Frozen tissue" & clinical_data_rm_wes$HPV_status_temp == "Negative"] , ploidy)) + geom_boxplot(linewidth = 0.8) +
  theme_bw(base_size = 30, base_family = "Helvetica") +
  labs(x = "", y = "Ploidy") + 
  theme(text = element_text(size = 18)) + 
  stat_compare_means(label= "p", label.x = 1.4) +
...
molecular_scores[samples_data_rm_wes$specimen_type == "Fresh Frozen tissue" & clinical_data_rm_wes$HPV_status_temp == "Negative",]  %>%
  ggplot(aes(clinical_data_rm_wes$Consumption[samples_data_rm_wes$specimen_type == "Fresh Frozen tissue" & clinical_data_rm_wes$HPV_status_temp == "Negative"] , CNA_altered)) + geom_boxplot(linewidth = 0.8) +
  theme_bw(base_size = 30, base_family = "Helvetica") +
  labs(x = "", y = "Fraction genome altered") + 
  theme(text = element_text(size = 18)) + 
  stat_compare_means(label= "p", label.x = 1.4) +
...
```{r}
#Figure S4B) Effect of diagnosis site on genomic parameters
molecular_scores[clinical_data_rm_wes$HPV_status_temp == "Negative",]  %>%
  ggplot(aes(clinical_data_rm_wes$Prim_diagnosis[clinical_data_rm_wes$HPV_status_temp == "Negative"] , tmb)) + geom_boxplot(linewidth = 0.8) +
  theme_bw(base_size = 30, base_family = "Helvetica") +
  labs(x = "", y = "TMB (mutations/Mb)") + 
  theme(text = element_text(size = 18)) + 
  stat_compare_means(label= "p", label.x = 1.4) +
  scale_x_discrete(labels = c("Oral_cavity" = "Oral cavity"))

molecular_scores[samples_data_rm_wes$specimen_type == "Fresh Frozen tissue" & clinical_data_rm_wes$HPV_status_temp == "Negative",]  %>%
  ggplot(aes(clinical_data_rm_wes$Prim_diagnosis[samples_data_rm_wes$specimen_type == "Fresh Frozen tissue" & clinical_data_rm_wes$HPV_status_temp == "Negative"] , ploidy)) + geom_boxplot(linewidth = 0.8) +
  theme_bw(base_size = 30, base_family = "Helvetica") +
  labs(x = "", y = "Ploidy") + 
  theme(text = element_text(size = 18)) + 
  stat_compare_means(label= "p", label.x = 1.4) +
...
molecular_scores[samples_data_rm_wes$specimen_type == "Fresh Frozen tissue" & clinical_data_rm_wes$HPV_status_temp == "Negative",]  %>%
  ggplot(aes(clinical_data_rm_wes$Prim_diagnosis[samples_data_rm_wes$specimen_type == "Fresh Frozen tissue" & clinical_data_rm_wes$HPV_status_temp == "Negative"] , CNA_altered)) + geom_boxplot(linewidth = 0.8) +
  theme_bw(base_size = 30, base_family = "Helvetica") +
  labs(x = "", y = "Fraction genome altered") + 
  theme(text = element_text(size = 18)) + 
  stat_compare_means(label= "p", label.x = 1.4) +
...
```{r}
#Figure 5A) Genomic features affected by disease extent
...
```{r}
#Figure S5A) Genomic parameters according to disease extent in HPV-negative patients
molecular_scores[clinical_data_rm_wes$HPV_status_temp == "Negative",]  %>%
  ggplot(aes(clinical_data_rm_wes$Metastatic_at_Rbiopsy[clinical_data_rm_wes$HPV_status_temp == "Negative"] , tmb)) + geom_boxplot(linewidth = 0.8) +
  theme_bw(base_size = 30, base_family = "Helvetica") +
  labs(x = "", y = "TMB (mutations/Mb)") + 
  theme(text = element_text(size = 18)) + 
  stat_compare_means(label= "p", label.x = 1.4) +
  scale_x_discrete(labels = c("No" = "LRR", "Yes" = "DM"))

molecular_scores[samples_data_rm_wes$specimen_type == "Fresh Frozen tissue" & clinical_data_rm_wes$HPV_status_temp == "Negative",]  %>%
  ggplot(aes(clinical_data_rm_wes$Metastatic_at_Rbiopsy[samples_data_rm_wes$specimen_type == "Fresh Frozen tissue" & clinical_data_rm_wes$HPV_status_temp == "Negative"] , ploidy)) + geom_boxplot(linewidth = 0.8) +
  theme_bw(base_size = 30, base_family = "Helvetica") +
  labs(x = "", y = "Ploidy") + 
  theme(text = element_text(size = 18)) + 
  stat_compare_means(label= "p", label.x = 1.4) +
...
molecular_scores[samples_data_rm_wes$specimen_type == "Fresh Frozen tissue" & clinical_data_rm_wes$HPV_status_temp == "Negative",]  %>%
  ggplot(aes(clinical_data_rm_wes$Metastatic_at_Rbiopsy[samples_data_rm_wes$specimen_type == "Fresh Frozen tissue" & clinical_data_rm_wes$HPV_status_temp == "Negative"] , CNA_altered)) + geom_boxplot(linewidth = 0.8) +
  theme_bw(base_size = 30, base_family = "Helvetica") +
  labs(x = "", y = "Fraction genome altered") + 
  theme(text = element_text(size = 18)) + 
  stat_compare_means(label= "p", label.x = 1.4) +
...
```{r}
#Figure S5B) Genomic parameters according to disease extent in HPV-positive patients
molecular_scores[clinical_data_rm_wes$HPV_status_temp == "Positive",]  %>%
  ggplot(aes(clinical_data_rm_wes$Metastatic_at_Rbiopsy[clinical_data_rm_wes$HPV_status_temp == "Positive"] , tmb)) + geom_boxplot(linewidth = 0.8) +
  theme_bw(base_size = 30, base_family = "Helvetica") +
  labs(x = "", y = "TMB (mutations/Mb)") + 
  theme(text = element_text(size = 18)) + 
  stat_compare_means(label= "p", label.x = 1.4) +
...
molecular_scores[samples_data_rm_wes$specimen_type == "Fresh Frozen tissue" & clinical_data_rm_wes$HPV_status_temp == "Positive",]  %>%
  ggplot(aes(clinical_data_rm_wes$Metastatic_at_Rbiopsy[samples_data_rm_wes$specimen_type == "Fresh Frozen tissue" & clinical_data_rm_wes$HPV_status_temp == "Positive"] , ploidy)) + geom_boxplot(linewidth = 0.8) +
  theme_bw(base_size = 30, base_family = "Helvetica") +
  labs(x = "", y = "Ploidy") + 
  theme(text = element_text(size = 18)) + 
  stat_compare_means(label= "p", label.x = 1.4) +
...
molecular_scores[samples_data_rm_wes$specimen_type == "Fresh Frozen tissue" & clinical_data_rm_wes$HPV_status_temp == "Positive",]  %>%
  ggplot(aes(clinical_data_rm_wes$Metastatic_at_Rbiopsy[samples_data_rm_wes$specimen_type == "Fresh Frozen tissue" & clinical_data_rm_wes$HPV_status_temp == "Positive"] , CNA_altered)) + geom_boxplot(linewidth = 0.8) +
  theme_bw(base_size = 30, base_family = "Helvetica") +
  labs(x = "", y = "Fraction genome altered") + 
  theme(text = element_text(size = 18)) + 
  stat_compare_means(label= "p", label.x = 1.4) +
...
```{r}
#Figure 6B) Genomic features affected by treatment lines
ff_mut <- ff_mut %>% mutate(alteration= "") %>% mutate(type= "Mutations")
...
```{r}
#Figure 6A) Effect of treatment lines in genomic parameters in HPV-negative patients
molecular_scores[clinical_data_rm_wes$HPV_status_temp == "Negative", ]  %>%
