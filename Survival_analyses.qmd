...
```{r}
#Figure 5A left) Prognostic features
final_cox %>%
  ggplot(aes(
...
```{r}
#Figure 5A) right panel - Subgroup analysis of prognostic features
...
```{r}
#Figure 5B-E) Kaplan-Meier plots
plot_survival(
...
```{r}
#Figure 5B-E) Multivariate Cox survival models
